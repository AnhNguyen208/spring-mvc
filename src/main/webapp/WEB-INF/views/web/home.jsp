...
<body>
	...
	<div class="container">
		...
		<div class="row align-items-center my-5">
			<div class="col-lg-7">
				<img src="template/web/image/image1.jpg" class="img-fluid" alt="Wild Landscape" />
			</div>
			<!-- /.col-lg-8 -->
			<div class="col-lg-5">
				<h1 class="font-weight-light">Store management website</h1>
				<p></p>
		...
		<div class="row">
			<div class="col-md-4 mb-5">
				<div class="card h-100">
					<div class="card-body">
						<img src="template/web/image/image2.jpg" class="img-fluid" alt="Wild Landscape" />
			...
			<div class="col-md-4 mb-5">
				<div class="card h-100">
					<div class="card-body">
						...
						<img src="template/web/image/image5.jpg" class="img-fluid" alt="Wild Landscape" />
						<p class="card-text">Lorem ipsum dolor sit amet, consectetur
			...
			<div class="col-md-4 mb-5">
				<div class="card h-100">
					<div class="card-body">
						...
						<img src="template/web/image/image4.jpg" class="img-fluid" alt="Wild Landscape" />
						<p class="card-text">Lorem ipsum dolor sit amet, consectetur
							adipisicing elit. Rem magni quas ex numquam, maxime minus quam
							molestias corporis quod, ea minima accusamus.</p>
					</div>
